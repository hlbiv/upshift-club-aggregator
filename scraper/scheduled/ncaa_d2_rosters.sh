#!/usr/bin/env bash
# NCAA D2 roster scrape — men's + women's, current season only.
#
...
python3 run.py --source ncaa-rosters --all --division D2 --gender mens
python3 run.py --source ncaa-rosters --all --division D2 --gender womens
