#!/usr/bin/env bash
# NCAA D3 roster scrape — men's + women's, current season only.
#
...
python3 run.py --source ncaa-rosters --all --division D3 --gender mens
python3 run.py --source ncaa-rosters --all --division D3 --gender womens
